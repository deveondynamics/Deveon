    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <!-- Logo -->
            <a class="logo" href="#">
                <img src="{{asset('FrontendAssets/imgs/Logo-light.svg')}}" alt="logo">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../inner_pages/about.html">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../inner_pages/portfolio-cards.html">Portfolio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../inner_pages/blog-grid.html">Services</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="../inner_pages/blog-grid.html">Contact</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container-fluid rest d-flex">
            ...
            <div class="cont-info valign">
                <div class="text-center full-width">
                    <div class="logo">
                        <img src="{{asset('FrontendAssets/imgs/Logo-light.svg')}}" alt="">
                    </div>
