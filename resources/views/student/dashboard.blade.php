                  ...
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">                                       
                        <svg class="stroke-icon">
                          <use href="AdminAssets/svg/icon-sprite.svg')}}#stroke-home"></use>
                        </svg></a></li>
                    ...
                    <div class="card widget-hover overflow-hidden">
                      ...
                      <div class="card-body pt-0 count-student">
                        <div class="school-wrapper"> 
                          ...
                          <div class="school-body"> <img src="{{asset('AdminAssets/images/dashboard-7/icon-2.svg')}}" alt="total teachers">
                            <div class="right-line"><img src="{{asset('AdminAssets/images/dashboard-7/line.png')}}" alt="line"></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card widget-hover overflow-hidden">
                      ...
                      <div class="card-body pt-0 count-student">
                        <div class="school-wrapper"> 
                          ...
                          <div class="school-body"> <img src="{{asset('AdminAssets/images/dashboard-7/icon1.svg')}}" alt="total students">
                            <div class="right-line"><img src="{{asset('AdminAssets/images/dashboard-7/line.png')}}" alt="line"></div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card widget-hover overflow-hidden">
                      ...
                      <div class="card-body pt-0 count-student">
                        <div class="school-wrapper"> 
                          ...
                          <div class="school-body"> <img src="{{asset('AdminAssets/images/dashboard-7/icon-3.svg')}}" alt="Total parents">
                            <div class="right-line"><img src="{{asset('AdminAssets/images/dashboard-7/line.png')}}" alt="line"></div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="col-xl-7 col-md-8 box-col-none">
                            <div class="row g-3">
                              <div class="col-xl-12"> 
                                <div class="light-card attendance-card widget-hover">
                                  <div class="left-overview-content">
                                    <div class="svg-box"><img src="{{asset('AdminAssets/images/dashboard-7/attendance/1.png')}}" alt="homework"></div>
                                  </div>
                              ...
                              <div class="col-xl-12"> 
                                <div class="light-card attendance-card widget-hover">
                                  <div class="left-overview-content">
                                    <div class="svg-box"><img src="{{asset('AdminAssets/images/dashboard-7/attendance/2.png')}}" alt="tests"></div>
                                  </div>
                                  <div class="right-overview-content">
                                    <div> 
                              ...
                              <div class="col-xl-12"> 
                                <div class="light-card attendance-card widget-hover">
                                  <div class="left-overview-content">
                                    <div class="svg-box"><img src="{{asset('AdminAssets/images/dashboard-7/attendance/3.png')}}" alt="attendance"></div>
                                  </div>
                                  <div class="right-overview-content">
                                    <div> 
                                        ...
                                        <ul class="task-icons">
                                          ...
                                          <li class="f-light flex-wrap">
                                            <svg class="fill-icon fill-primary">
                                              <use href="AdminAssets/svg/icon-sprite.svg')}}#clock"></use>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body pt-0 position-relative pb-0 pe-0 increase-content">
                        <div class="knowledge-wrapper">
                          ...
                          <div class="knowledgebase-wrapper"><img class="knowledge-img img-fluid w-100" src="{{asset('AdminAssets/images/dashboard-7/knowledge-base.png')}}" alt="knowledge-base"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="card-body pt-0">
                        <div class="student-leader-wrapper">
                          <div class="student-leader-content light-card">
                            <div class="d-flex align-items-center gap-2"><img src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/rank-1.svg')}}" alt="rank-1"><img class="leader-img" src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/user-1.jpg')}}" alt="user 1">
                          ...
                          <div class="student-leader-content light-card">
                            <div class="d-flex align-items-center gap-2"><img src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/rank-2.svg')}}" alt="rank-2"><img class="leader-img" src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/user-2.jpg')}}" alt="user 2">
                              <div class="leader-content-height">
                          ...
                          <div class="student-leader-content light-card">
                            <div class="d-flex align-items-center gap-2"><img src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/rank-3.svg')}}" alt="rank-2"><img class="leader-img" src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/user-3.jpg')}}" alt="user 3">
                              <div class="leader-content-height">
                          ...
                          <div class="student-leader-content">
                            <div class="d-flex align-items-center gap-2">
                              <h5>4<sup>th</sup></h5><img class="leader-img" src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/user-4.jpg')}}" alt="user 4">
                              <div class="leader-content-height">
                          ...
                          <div class="student-leader-content">
                            <div class="d-flex align-items-center gap-2">
                              <h5>5<sup>th</sup></h5><img class="leader-img" src="{{asset('AdminAssets/images/dashboard-7/attendance/student-leader/user-5.jpg')}}" alt="user 4">
                              <div class="leader-content-height">
                      ...
                      <table class="table" id="unpaid-fees"> 
                        ...
                        <tbody> 
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/10.jpg')}}" alt="user">
                          ...
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/11.jpg')}}" alt="user">
                          ...
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/12.jpg')}}" alt="user">
                          ...
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/13.jpg')}}" alt="user">
                          ...
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/user/6.jpg')}}" alt="user">
                          ...
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/user/3.png')}}" alt="user">
                          ...
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/user/10.jpg')}}" alt="user">
                          ...
                          <tr>
                            <td> </td>
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/user/12.png')}}" alt="user">
                      ...
                      <table class="table" id="top-students"> 
                        ...
                        <tbody> 
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/1.jpg')}}" alt="user">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/2.jpg')}}" alt="user">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/4.jpg')}}" alt="user">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/5.jpg')}}" alt="user">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/3.jpg')}}" alt="user">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/6.jpg')}}" alt="user">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/7.jpg')}}" alt="user">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard/user/8.jpg')}}" alt="user">
                    ...
                    <div class="recent-table table-responsive custom-scrollbar">
                      <table class="table" id="enroll-student">
                        ...
                        <tbody> 
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-11/user/4.jpg')}}" alt="user">
                          ...
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-11/user/3.jpg')}}" alt="user">
                          ...
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-11/user/1.jpg')}}" alt="user">
                          ...
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-9/user/5.png')}}" alt="user">
                          ...
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-9/user/1.png')}}" alt="user">
                          ...
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-9/user/2.png')}}" alt="user">
                                <div class="img-content-box"><a class="f-w-500" href="user-profile.html">Stella Morgan</a></div>
                              </div>
                            </td>
                            <td>#658965</td>
                          ...
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-9/user/3.png')}}" alt="user">
                          ...
                          <tr> 
                            <td>
                              <div class="common-align justify-content-start"><img class="img-fluid img-40 rounded-circle me-2" src="{{asset('AdminAssets/images/dashboard-9/user/4.png')}}" alt="user">
