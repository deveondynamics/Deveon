...
<body>
                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#6e070008012e0f140b001a400d0103"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="224b4c444d62475a434f524e470c414d4f">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
    ...
    <div class="page-wrapper">
                ...
                <div class="team-details-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay=".5s">
                            <div class="team-details-content ps-xxl-4 pt-4">
                                ...
                                <p class="mt-3">
                                    Yours generate more profits by building awareness, driving web traffic, connecting
                                    with customers.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-4  wow fadeInUp" data-wow-delay=".5s">
                            <div class="team-details-contact ms-xxl-5">
                                <div class="team-content-box">
                                    <ul class="team-infobox">
                                        ...
                                        <li class="d-flex align-items-center gap-4">
                                            ...
                                            <span class="white-clr">
                                                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7f05100b1a1c173f18121e1613511c1012">[email&#160;protected]</a>
                                            </span>
                                        </li>
                                        <li class="d-flex align-items-center gap-4">
                                            <span class="white-clr">
        ...
        <section class="team-skill fix section-padding pt-5">
            <div class="container">
                <div class="team-skill-wrapper">
                    <div class="row">
                        <div class="col-lg-7 wow fadeInUp" data-wow-delay=".3s">
                            <div class="team-skill-content pe-xxl-5">
                                <h3>About Me</h3>
                                <p class="mt-2">Prior to joining, James taught at The Hebrew University, the Jerusalem
                                    Institute of
                                    Management, and served in my country’s Army. Active in civic and professional
                                    affairs, Orit Most recently, I led Galvanize’s SF’s 6 month immersive program as
                                    Lead Instructor and Curriculum Director. After graduating from my class,</p>

                                <p class="mt-4">I’ve since focused my time on bringing my teaching experience to an
                                    online
                                    environment. In 2021 I launched my Web Developer Bootcamp course.</p>
                            </div>
                        </div>
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6913061d0c0a01290e04080005470a0604">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
