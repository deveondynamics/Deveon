...
<body>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#87eee9e1e8c7e6fde2e9f3a9e4e8ea"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="40292e262f002538212d302c256e232f2d">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
    ...
    <div class="page-wrapper">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-contact-card d-flex align-items-center">
                            ...
                            <div class="title">
                                <span>Mail us</span>
                                <h4><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4a222f2626250a30253e2f292264292527">[email&#160;protected]</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="contact-us-wrapper contact-us-2 section-padding">
            ...
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2>Dealing in All <br> Professional IT Services</h2>
                </div>
        ...
        <!-- CTA Section Start -->
        <section class="cta-wrapper cta-2 style-3 section-bg">
            <div class="container">
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="502a3f2435333810373d31393c7e333f3d">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
