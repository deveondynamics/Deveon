                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#d9b0b7bfb699b8a3bcb7adf7bab6b4"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="5c35323a331c39243d312c3039723f3331">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
        ...
        <section class="pricing-wrapper pricing-1 style-2 section-padding pb-0">
            ...
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="split-text right">Pricing That Suits <br> Your Needs</h2>
                </div>
                <div class="row g-4 align-items-center mt-4">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-delay="400ms">
                        <div class="single-pricing-item border-style">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    1500 Creative Technology Units
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    24/7 Remote Support
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-delay="600ms">
                        <div class="single-pricing-item">
                            ...
                            <div class="price">$539 <span> / Per month </span></div>
                            <a href="pricing.html" class="theme-btn trasparent-btn-2 black-btn"><span>Start Free
                                    Trial</span></a>
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="710b1e0514121931161c10181d5f121e1c">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
