                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#a4cdcac2cbe4c5dec1cad08ac7cbc9"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="462f28202906233e272b362a236825292b">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
                    ...
                    <div class="row">
                        <div class="col-12 col-xxl-8 col-xl-7">
                            <div class="blog-post-details border-wrap mt-0">
                                <div class="blog-details-image wow fadeInUp" data-wow-delay="100ms">
                                    <img src="assets/img/blog/details-1.jpg" alt="">
                                </div>
                                <div class="single-blog-post post-details mt-0 wow fadeInUp" data-wow-delay="200ms">
                                    <div class="post-content pt-0">
                                        ...
                                        <h3 class="mt-0">The whimsically named Egg Canvas brainchild </h3>
                                        <p>
                                            he whimsically named Egg Canvas is the brainchild of Erica Choi, a design
                                            director and photo Sit amet
                                            consect velit integer tincidunt scelerisque volutpat neque fermeny massa
                                            lacus. grapher based in York.
                                            Why the name “Egg Canvas Erica was inspired by her Korean childhood
                                            nickname, which means egg
                                        ...
                                        <p class="mt-4">
                                            ...
                                            vestibulum rhon cus,
                                            dolor eget viverra pretium, dolor tellus aliquet nunc, vitae ultricies erat
                                            elit eu lacus. Vestibulum non
                                            justo fun consectetur, cursus ante, tincidunt sapien. Nulla quis diam sit
                                            amet turpis interd enim.
                                        ...
                                        <h2 class="mt-0">Let our investment management team </h2>
                                        <div class="row">
                                        ...
                                        <p class="mt-4">
                                            ...
                                            memorial service.Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            vestibulum rhoncus, dolor eget viverra pretium, dolor ellus aliquet nunc,
                                        </p>
                                    </div>
                                </div>
                                <div class="row tag-share-wrap wow fadeInUp" data-wow-delay="300ms">
                                ...
                                <div class="comments-section-wrap mt-5 wow fadeInUp" data-wow-delay="400ms">
                                    ...
                                    <ul class="comments-item-list">
                                        <li class="single-comment-item">
                                            <div class="author-img">
                                                <img src="assets/img/blog/author_img1.jpg" alt="img">
                                            </div>
                                            <div class="author-info-comment">
                                                <div class="info">
                                                    <h5><a href="#">Rohan De Spond</a></h5>
                                                    <span>21th Feb 2025</span>
                                                    <a href="#" class="reply-btn"><i class="fal fa-reply-all"></i></a>
                                                </div>
                                                <div class="comment-text">
                                                    <p>There are many variations of passages of Lorem Ipsum available,
                                                        but the leap into electronic type setting, remaining
                                                        essentiallyuncha opularisedthe with the release of
                                                        Letrasetsheets containingth leap electrtypesetting</p>
                                                </div>
                                            </div>
                                            <ul class="replay-comment ms-xxl-5 ps-xxl-5">
                                                <li class="single-comment-item">
                                                    <div class="author-img">
                                                        <img src="assets/img/blog/author_img2.jpg" alt="img">
                                                    </div>
                                                    <div class="author-info-comment">
                                                        <div class="info">
                                                            <h5><a href="#">Johan Ritaxon</a></h5>
                                ...
                                <div class="comment-form-wrap d-block mt-3 wow fadeInUp" data-wow-delay="500ms">
                                    <h3>Post Comment</h3>
                                    ...
                                    <button class="theme-btn black-btn mt-4" type="submit">
                                        Post A Comment
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-xxl-4 col-xl-5">
                            <div class="main-sidebar">
                                <div class="single-sidebar-widget wow fadeInUp" data-wow-delay="200ms">
                                    ...
                                    <div class="popular-posts">
                                        <div class="single-post-item">
                                            <div class="thumb bg-cover"
                                                style="background-image: url('assets/img/blog/pp1.jpg');"></div>
                                        ...
                                        <div class="single-post-item">
                                            <div class="thumb bg-cover"
                                                style="background-image: url('assets/img/blog/pp2.jpg');"></div>
                                            <div class="post-content">
                                                <div class="post-date">
                                                    <i class="fal fa-calendar"></i>29 August, 2025
                                                </div>
                                        ...
                                        <div class="single-post-item">
                                            <div class="thumb bg-cover"
                                                style="background-image: url('assets/img/blog/pp3.jpg');"></div>
                                            <div class="post-content">
                                                <div class="post-date">
                                                    <i class="fal fa-calendar"></i>29 August, 2025
                                                </div>
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dda7b2a9b8beb59dbab0bcb4b1f3beb2b0">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
