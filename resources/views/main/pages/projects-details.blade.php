                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#e28b8c848da28398878c96cc818d8f"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="7d14131b123d18051c100d1118531e1210">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
            ...
            <div class="container">
                <div class="page-heading">
                    <div class="breadcrumb-sub-title">
                        <h1 class="wow fadeInUp" data-wow-delay=".3s">Projects Details</h1>
                ...
                <div class="project-details-wrapper">
                    <div class="row g-4">
                        <div class="col-xxl-8 col-lg-12">
                            <div class="project-details-content pe-xl-4">
                                <div class="project-details-image">
                                    <img src="assets/img/case/details-1.jpg" alt="img">
                                </div>
                                <h3 class="mt-4">Software Development Analysis</h3>
                                <p class="mb-3">
                                ...
                                <p>
                                    Building a powerful brand is essential to standing out in today's competitive
                                    market. Our Brand Development service focuses on crafting a unique identity that
                                    resonates with your target audience, strengthens your brand’s presence, and drives
                                    long-term success. We dive deep into understanding your business values, vision, and
                                    goals to create a brand that reflects your core essence. Contact us today to
                                ...
                                <h4 class="mt-4">Project Challenges</h4>
                                <p class="mb-3 mt-3">
                                ...
                                <div class="list">
                                    <ul>
                                        <li><i class="fas fa-check-circle"></i>Managed IT Services
                                        </li>
                                        <li><i class="fas fa-check-circle"></i>60+ Remove background/mon
                                        </li>
                                        <li><i class="fas fa-check-circle"></i>Data Backup Recovery
                                        </li>
                                    </ul>
                                    <ul>
                                        <li><i class="fas fa-check-circle"></i>New had happen unable uneasy
                                        </li>
                                        <li><i class="fas fa-check-circle"></i> Drawings can followed improved out
                                            sociable not
                                        </li>
                                        <li><i class="fas fa-check-circle"></i>Comparison new ham melancholy son
                                            themselves.
                                        </li>
                                    </ul>
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="82f8edf6e7e1eac2e5efe3ebeeace1edef">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
