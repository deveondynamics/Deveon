...
<body>
                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#f59c9b939ab5948f909b81db969a98"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="d6bfb8b0b996b3aeb7bba6bab3f8b5b9bb">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <div class="page-heading">
                    <div class="breadcrumb-sub-title">
                        <h1 class="wow fadeInUp" data-wow-delay=".3s">About Company</h1>
        ...
        <section class="about-wrapper about-1 style-2 about-page section-padding">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xxl-7 col-xl-6 col-lg-12 wow fadeInLeft" data-wow-delay="300ms">
                        <div class="about-images-2">
                            ...
                            <div class="image-2">
                                <img src="assets/img/about/10.png" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-5 col-xl-6 col-lg-12 wow fadeInRight" data-wow-delay="300ms">
                        <div class="about-content mt-xxl-5 mt-xl-0 mt-5 ms-xxl-2">
                            <div class="section-title">
                                ...
                                <h2>Accelerate Innovation <br /> with World-Class Tech
                                </h2>
                            </div>
        ...
        <div class="marquee-section section-padding pt-4">
            ...
            <div class="marque-wrapper style-2 mt-3">
                <div dir="rtl" class="swiper text-slider-2">
                    <div class="swiper-wrapper slide-transtion">
                        ...
                        <div class="swiper-slide brand-slide-element">
                            <div class="marque-text">
                                <h3>Customer Reviews Display</h3>
                            </div>
                        </div>
                        <div class="swiper-slide brand-slide-element">
                            <div class="marque-text">
                                <h3>FAQ Section Integration</h3>
                            </div>
                        </div>
                        <div class="swiper-slide brand-slide-element">
                            <div class="marque-text">
                        ...
                        <div class="swiper-slide brand-slide-element">
                            <div class="marque-text">
                                <h3>Personalized Service Options</h3>
                            </div>
                        </div>
                        <div class="swiper-slide brand-slide-element">
                            <div class="marque-text">
                                <h3>Service Location Tracker</h3>
                            </div>
                        </div>
                        <div class="swiper-slide brand-slide-element">
                            <div class="marque-text">
                                <h3>Multi-Step Service Checkout</h3>
                            </div>
                        </div>
                        <div class="swiper-slide brand-slide-element">
                            <div class="marque-text">
        ...
        <section class="choose-us-wrapper choose-us-3 section-padding section-bg choose-us-page">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-12 col-md-12 mt-xl-4 wow fadeInLeft" data-wow-delay="300ms">
                        <div class="choose-us-content ms-xl-4 ps-xl-1">
                            ...
                            <p class="mt-4">Deveon Dynamics is the partner of choice for many of the world’s <br> leading
                                enterprises,
                            </p>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 mt-xl-4">
                                    <div class="single-choose-item active bg-cover mt-4 mt-xl-0">
                                        <div class="shape">
                                            <img class="shape-2" src="assets/img/shape/shape-10.png" alt="">
                                            <img class="shape-3" src="assets/img/shape/shape-11.png" alt="">
                                        </div>
        ...
        <!-- Video Section Start -->
        <section class="video-wrapper video-1 style-2 video-page">
            <div class="container">
        ...
        <section class="pricing-wrapper pricing-1 style-2 section-padding pb-0">
            <div class="container">
                <div class="section-title text-center">
                    <div class="sub-title"><span>PRICING PLAN</span>
                    </div>
                    <h2>Pricing That Suits <br> Your Needs</h2>
                </div>
                <div class="row g-4 align-items-center mt-4">
                    <div class="col-xl-4 col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-delay="200ms">
                        <div class="single-pricing-item">
                            ...
                            <div class="price">$399 <span> / Per month </span></div>
                            <a href="pricing.html" class="theme-btn trasparent-btn-2 black-btn"><span>Start Free
                                    Trial</span></a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-delay="400ms">
                        <div class="single-pricing-item border-style">
                            <div class="price-btn">
                                BEST CHOCE
                            </div>
                            <div class="header">
                            ...
                            <div class="price">$399 <span> / Per month </span></div>
                            <a href="pricing.html" class="theme-btn theme-btn-2 black-btn"><span>Start Free
                                    Trial</span></a>
        ...
        <!-- Brand Section Start -->
        <section class="brand-wrapper brand-1 style-3 section-padding">
            <div class="shape">
                <img class="shape-1" src="assets/img/shape/shape-20.png" alt="">
            </div>
            <div class="container">
                <div class="brand-inner">
                    <p class="text-center mb-5 title">Trusted by 3450+ happy customers from the whole world</p>
        ...
        <footer class="footer-wrapper section-bg-2 section-padding pb-0">
            <div class="marquee-section mt-5 pt-5">
                <div class="mycustom-marque">
                    <div class="scrolling-wrap">
                        <div class="comm">
                            <div class="cmn-textslide color-2">Let’s Talk</div>
                            <div><img src="assets/img/marquee-box.png" alt="img"></div>
                            <div class="cmn-textslide">Let’s Talk</div>
                            <div><img src="assets/img/marquee-box-2.png" alt="img"></div>
                            <div class="cmn-textslide color-2">Let’s Talk</div>
                            <div><img src="assets/img/marquee-box.png" alt="img"></div>
                            <div class="cmn-textslide">Let’s Talk</div>
                            <div><img src="assets/img/marquee-box-2.png" alt="img"></div>
            ...
            <div class="container">
                <div class="footer-widgets-1 style-2  section-padding">
                    <div class="row g-5">
                        <div class="col-xl-3 col-lg-6 pe-xxl-0 wow fadeInUp" data-wow-delay="200ms">
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ef95809b8a8c87af88828e8683c18c8082">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
