...
<body>
                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#2c45424a436c4d56494258024f4341"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="d4bdbab2bb94b1acb5b9a4b8b1fab7bbb9">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <div class="page-heading">
                    <div class="breadcrumb-sub-title">
                        <h1 class="wow fadeInUp" data-wow-delay=".3s">Our Projects</h1>
        ...
        <section class="case-study-wrapper case-study-2 section-padding">
            <div class="container">
                ...
                <div class="tab-content">
                    <div id="all" class="tab-pane fade show active">
                        ...
                        <div class="case-study-grid">
                            <div class="single-case-item style-1 filter-item branding wow fadeInUp"
                                data-wow-delay=".5s">
                                <img src="assets/img/case/15.jpg" alt="img">
                                <div class="hover d-flex align-items-center justify-content-between">
                                    <div class="title">
                                        <span>FINANCE</span>
                                        <h4>Every software</h4>
                            ...
                            <div class="single-case-item style-2 filter-item branding wow fadeInUp"
                                data-wow-delay=".5s">
                                <img src="assets/img/case/16.jpg" alt="img">
                                <div class="hover d-flex align-items-center justify-content-between">
                                    <div class="title">
                                        <span>FINANCE</span>
                                        <h4>Every software</h4>
                            ...
                            <div class="single-case-item style-2 wow fadeInUp" data-wow-delay=".5s">
                                <img src="assets/img/case/17.jpg" alt="img">
                                <div class="hover d-flex align-items-center justify-content-between">
                                    <div class="title">
                                        <span>FINANCE</span>
                                        <h4>Every software</h4>
                        ...
                        <div class="case-study-grid">
                            <div class="single-case-item style-2 filter-item branding wow fadeInUp"
                                data-wow-delay=".5s">
                                <img src="assets/img/case/18.jpg" alt="img">
                                <div class="hover d-flex align-items-center justify-content-between">
                                    <div class="title">
                                        <span>FINANCE</span>
                                        <h4>Every software</h4>
                            ...
                            <div class="single-case-item style-2 filter-item web-design branding wow fadeInUp"
                                data-wow-delay=".5s">
                                <img src="assets/img/case/19.jpg" alt="img">
                                <div class="hover d-flex align-items-center justify-content-between">
                                    <div class="title">
                                        <span>FINANCE</span>
                                        <h4>Every software</h4>
                            ...
                            <div class="single-case-item style-1 filter-item web-design branding wow fadeInUp"
                                data-wow-delay=".5s">
                                <img src="assets/img/case/20.jpg" alt="img">
                                <div class="hover d-flex align-items-center justify-content-between">
                                    <div class="title">
                                        <span>FINANCE</span>
                                        <h4>Every software</h4>
        ...
        <!-- CTA Section Start -->
        <section class="cta-wrapper cta-2 style-3 section-padding pb-0">
            <div class="container">
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bcc6d3c8d9dfd4fcdbd1ddd5d092dfd3d1">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
