...
<body>
                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#87eee9e1e8c7e6fde2e9f3a9e4e8ea"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="442d2a222b04213c25293428216a272b29">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
    ...
    <div class="page-wrapper">
        ...
        <section class="service-wrapper service-4 section-bg section-padding">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2>Preparing for Your Success, We <br> Provide Truly IT Solutions.
                    </h2>
                </div>
                <div class="service-inner text-center overflow-hidden mt-4 pt-3">
                    <div class="row gy-xxl-5">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <div class="signle-service-item wow fadeInUp" data-wow-delay="200ms">
                                ...
                                <div class="line mb-4"></div>
                                <h4><a href="services-details.html">Management</a></h4>
                                <p class="pt-3">Back up your database, store in a safe and secure place while still
                                    maintaining.
                                </p>
                                <a href="services-details.html" class="infu-btn">Read More<i
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <div class="signle-service-item wow fadeInUp" data-wow-delay="400ms">
                                <div class="service-bg bg-cover"
                                    style="background-image: url(assets/img/service/08.jpg);"></div>
                                <div class="icon"><i class="flaticon-engineering"></i></div>
                                <div class="line mb-4"></div>
                                <h4><a href="services-details.html">Data Science</a></h4>
                                <p class="pt-3">Back up your database, store in a safe and secure place while still
                                    maintaining.
                                </p>
                                <a href="services-details.html" class="infu-btn">Read More<i
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <div class="signle-service-item wow fadeInUp" data-wow-delay="600ms">
                                ...
                                <div class="line mb-4"></div>
                                <h4><a href="services-details.html">Pro Technology</a></h4>
                                <p class="pt-3">Back up your database, store in a safe and secure place while still
                                    maintaining.
                                </p>
                                <a href="services-details.html" class="infu-btn">Read More<i
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <div class="signle-service-item wow fadeInUp" data-wow-delay="800ms">
                                <div class="service-bg bg-cover"
                                    style="background-image: url(assets/img/service/08.jpg);"></div>
                                <div class="icon"><i class="flaticon-connection"></i></div>
                                <div class="line mb-4"></div>
                                <h4><a href="services-details.html">IT Consultant</a></h4>
                                <p class="pt-3">Back up your database, store in a safe and secure place while still
                                    maintaining.
                                </p>
                                <a href="services-details.html" class="infu-btn">Read More<i
                    ...
                    <div class="page-nav-wrap mt-5 text-center wow fadeInUp" data-wow-delay=".3s">
                        <ul>
                            <li><a class="page-numbers" href="#"><i class="far fa-angle-right"></i></a></li>
        ...
        <section class="pricing-wrapper pricing-1 style-2 section-padding">
            <div class="container">
                <div class="section-title text-center">
        ...
        <section class="process-wrapper process-2 section-padding section-bg">
            <div class="container">
                <div class="section-title text-center">
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="106a7f6475737850777d71797c3e737f7d">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
