                    ...
                    <div class="offcanvas__contact">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a href="/cdn-cgi/l/email-protection#a7cec9c1c8e7c6ddc2c9d389c4c8ca"><span
                                            class="mailto:info@example.com"><span class="__cf_email__" data-cfemail="cea7a0a8a18eabb6afa3bea2abe0ada1a3">[email&#160;protected]</span></span></a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
            ...
            <div class="container">
                <div class="page-heading">
                    <div class="breadcrumb-sub-title">
                        <h1 class="wow fadeInUp" data-wow-delay=".3s">404 Page</h1>
        ...
        <section class="error-section section-padding fix">
            <div class="container">
                <div class="error-content text-center">
                    ...
                    <h3 class="wow fadeInUp" data-wow-delay=".3s">Page Not Found</h3>
                    <p class="text-center w-50 w-sm-100 mx-auto">Prior to joining, James taught at The Hebrew
                        University, the Jerusalem Institute of Management,
                        and served in my country’s Army. Active in civic and professional affairs, Orit Most recently.
                    </p>
                    <a href="index.html" class="theme-btn black-btn mt-5 wow fadeInUp" data-wow-delay=".5s">
                        Back To Home
                    </a>
                </div>
            </div>
                                    ...
                                    <div class="contact-info-area">
                                        <div class="contact">
                                            ...
                                            <div class="contact-infu">
                                                ...
                                                <h5 class="text-white text-lowercase"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ccb6a3b8a9afa48caba1ada5a0e2afa3a1">[email&#160;protected]</a></h5>
                                            </div>
                                        </div>
                                        <div class="contact">
